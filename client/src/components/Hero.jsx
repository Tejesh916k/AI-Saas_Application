...
const Hero = () => {
  ...
  return (
    ...
    bg-gradient-to-br from-sky-100 to-yellow-50'> 

    <div className='text-center mb-b'>
      ...
      max-sm:text-xs text-gray-600'> Transform your content creation with our suite of premium AI tools.
        ...
        <div className='flex flex-wrap justify-center mt-2 gap-5 text-sm max-sm:text-xs'>
            ...
            <button className='bg-white px-10 py-3 
            rounded-lg border border-gray-300 hover:scale-102 active:scale-95 transition'>
              watch demo</button>
        </div>
