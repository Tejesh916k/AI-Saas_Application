...
  const imageStyle= [ 'Realistic', 'Cartoon', '3D Style', 'Pixel Art', 'Gibili style', 'Surreal', 'portrait Style', 'Pop Art', 'Vintage', 'Fantasy' ]
   
...
            <Sparkles className="w-6 text-[#06b6d4]" />
  
...
         <textarea 
  ...
  placeholder=' Describe what u want 2 see in the image  ' 
  required
/>
  
...
      </div>
      ...
      <div className='my-6 flex items-center gap-2'>
        <label className='relative cursor-pointer'>
          ...
          peer-checked:bg-blue-500 transition'></div>
...
      bg-gradient-to-r from-sky-500 to-sky-600 text-white px-4 py-2 rounded-md mt-6 hover:from-sky-600 hover:to-sky-700'>
        <Image className='w-5'/>
        Generate Image
      </button> 
  
